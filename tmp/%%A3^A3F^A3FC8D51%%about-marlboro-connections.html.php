<?php /* Smarty version 2.6.13, created on 2011-09-28 09:11:28
    	...
    	<div id="about">
        	<div class="content">
            	...
            	<div class="about">  
                    ...
                    <p>Connections is an unforgettable ten days journey to Berlin, Istanbul and New York. An opportunity for you and your adult smoke friend to be VIPs as you're taken from one unique experience to another.</p>
                    <p>Have fun unlocking each city's badges. Each badge tells part of the connections story and is unlocked using connection codes. Explore your city, find the codes, trade badges with adult smoker friend redeem them for special prizes. Discover all the badges and unique experiences await you!</p>
					<a href="#videoPlay">
